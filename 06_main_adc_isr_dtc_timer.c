...
void init_adc(){
     ...
     */
    ADC10CTL1 = INCH_1 + CONSEQ_3 + SHS_2;
...
void init_timer_A0(){
    ...
    /* Timer A0:
    *
    * TASSEL_a -> Clock de ACLK.
    * MC_2 -> Contagem  até CCR0.
    */
    TA0CTL = TASSEL_1 + MC_1;

    /* Contage máxima do temporizador */
    TA0CCR0 = 128-1;

    /* Ativa saída do timer e habilita IRQ
     *
     * IRQ não é necesária para o trigger
     */
